...
class GUI_dl(tk.Frame):
    ...
    def main_frame (self, root):    # Main frame of the GUI  
        ...
        _=definition_run_cancel_buttons_type_1("tab1",
                                     [lambda:run_algorithm_1(self, t1_combo_point_cloud_training.get(),t1_combo_point_cloud_testing.get(), int(t1_entry_gpu.get()), int(t1_entry_iterations.get())),lambda:destroy(self)],
                                     6,
                                     tab1,
                                     1
                                     )
        ...
        def run_algorithm_1 (self,pc_training_name,pc_testing_name,gpu_value,epoch_value):
